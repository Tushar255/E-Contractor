...
export const registerUser = async (req, res) => {
    try {
        const { name, city, email, password, value, workType, shopAddress } = req.body
        ...
        let img = "https://icon-library.com/images/anonymous-avatar-icon/anonymous-avatar-icon-25.jpg";
        if (value === "vendor" && req.body.pic) {
            img = req.body.pic;
        }
